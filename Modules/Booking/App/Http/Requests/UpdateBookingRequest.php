...
class UpdateBookingRequest extends FormRequest
{
    ...
    {
        return true; // route-level `permission:booking.edit` middleware is the real gate
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'preparer_id' => ['sometimes', 'required', 'integer', Rule::exists('users', 'id')->whereNull('deleted_at')],
